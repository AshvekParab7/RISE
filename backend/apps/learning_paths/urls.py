...
from .views import CheckpointView, FinalChallengeView, LearningPathDetailView, LearningPathListView, LearningPathStatusView, LevelCompleteView, LevelDetailView, LevelListView, LevelStartView, NotesView, ResumeView, YouTubeLearningCreateView
