...
from .classroom_views import ClassroomAuthorizeView, ClassroomStatusView, ClassroomSyncView
...
urlpatterns = [
    ...
    path('google/classroom/authorize/', ClassroomAuthorizeView.as_view()),
