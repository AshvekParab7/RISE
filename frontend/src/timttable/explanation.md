...
6. What should I do now? asks the existing intelligence priority engine for the highest-impact topic or subject. Start focus sends the student to the existing focus workflow.
